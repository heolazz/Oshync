...
const MainHeader = ({ icons }) => {
    ...
    return (
        <header className="flex justify-between items-center p-5 px-8">
            <button className="flex items-center gap-2 bg-white px-5 py-2 rounded-full text-[10px] font-black uppercase text-slate-800 shadow-sm border border-slate-100 hover:translate-y-[-2px] transition-all">
                <SkipBack className="rotate-180" size={12} fill="currentColor" /> Back to Home
            </button>

            <div className="bg-white px-5 py-2 rounded-full flex items-center gap-4 shadow-sm border border-slate-100">
